...
('CU101', 1, 1, 'occupied'), ('CU102', 1, 0, 'available'), ('CU103', 1, 1, 'occupied'), ('CU104', 1, 0, 'available'), ('CU105', 1, 1, 'occupied'),
('CU201', 2, 1, 'occupied'), ('CU202', 2, 0, 'available'), ('CU203', 2, 1, 'occupied'), ('CU204', 2, 0, 'available'), ('CU205', 2, 0, 'available'),
('CU301', 3, 2, 'occupied'), ('CU302', 3, 1, 'available'), ('CU303', 3, 2, 'occupied'), ('CU304', 3, 0, 'available'), ('CU305', 3, 1, 'available'),

-- Bangkok Student Hub (Rooms 16-30)
('BSH101', 4, 1, 'occupied'), ('BSH102', 4, 0, 'available'), ('BSH103', 4, 1, 'occupied'), ('BSH104', 4, 0, 'available'), ('BSH105', 4, 0, 'available'),
('BSH201', 5, 1, 'occupied'), ('BSH202', 5, 0, 'available'), ('BSH203', 5, 1, 'occupied'), ('BSH204', 5, 0, 'available'), ('BSH205', 5, 1, 'occupied'),
('BSH301', 6, 1, 'occupied'), ('BSH302', 6, 0, 'available'), ('BSH303', 6, 1, 'occupied'), ('BSH304', 6, 0, 'available'), ('BSH305', 6, 0, 'available'),

-- Victory Monument Residence (Rooms 31-40)
('VM101', 7, 1, 'occupied'), ('VM102', 7, 0, 'available'), ('VM103', 7, 1, 'occupied'), ('VM104', 7, 0, 'available'), ('VM105', 7, 0, 'available'),
('VM201', 8, 2, 'occupied'), ('VM202', 8, 1, 'available'), ('VM203', 8, 2, 'occupied'), ('VM204', 8, 0, 'available'), ('VM205', 8, 1, 'available'),

-- Sukhumvit Student Lodge (Rooms 41-50)
('SSL101', 9, 1, 'occupied'), ('SSL102', 9, 0, 'available'), ('SSL103', 9, 1, 'occupied'), ('SSL104', 9, 0, 'available'), ('SSL105', 9, 0, 'available'),
('SSL201', 10, 2, 'occupied'), ('SSL202', 10, 1, 'available'), ('SSL203', 10, 2, 'occupied'), ('SSL204', 10, 0, 'available'), ('SSL205', 10, 1, 'available'),

-- Asok Tower Dormitory (Rooms 51-60)
('ATD101', 11, 1, 'occupied'), ('ATD102', 11, 0, 'available'), ('ATD103', 11, 1, 'occupied'), ('ATD104', 11, 0, 'available'), ('ATD105', 11, 0, 'available'),
('ATD201', 12, 1, 'occupied'), ('ATD202', 12, 0, 'available'), ('ATD203', 12, 1, 'occupied'), ('ATD204', 12, 0, 'available'), ('ATD205', 12, 1, 'occupied'),

-- Thonburi Riverside Dorm (Rooms 61-70)
('TRD101', 13, 1, 'occupied'), ('TRD102', 13, 0, 'available'), ('TRD103', 13, 1, 'occupied'), ('TRD104', 13, 0, 'available'), ('TRD105', 13, 0, 'available'),
('TRD201', 14, 1, 'occupied'), ('TRD202', 14, 0, 'available'), ('TRD203', 14, 1, 'occupied'), ('TRD204', 14, 0, 'available'), ('TRD205', 14, 0, 'available'),

-- Chatuchak Park Residence (Rooms 71-80)
('CPR101', 15, 1, 'occupied'), ('CPR102', 15, 0, 'available'), ('CPR103', 15, 1, 'occupied'), ('CPR104', 15, 0, 'available'), ('CPR105', 15, 0, 'available'),
('CPR201', 16, 3, 'occupied'), ('CPR202', 16, 0, 'available'), ('CPR203', 16, 2, 'available'), ('CPR204', 16, 0, 'available'), ('CPR205', 16, 1, 'available'),

-- Sathorn Business Dorm (Rooms 81-90)
('SBD101', 17, 1, 'occupied'), ('SBD102', 17, 0, 'available'), ('SBD103', 17, 1, 'occupied'), ('SBD104', 17, 0, 'available'), ('SBD105', 17, 0, 'available'),
('SBD201', 18, 1, 'occupied'), ('SBD202', 18, 0, 'available'), ('SBD203', 18, 1, 'occupied'), ('SBD204', 18, 0, 'available'), ('SBD205', 18, 0, 'available'),

-- Chiang Mai University Dorm (Rooms 91-100)
('CMU101', 19, 1, 'occupied'), ('CMU102', 19, 0, 'available'), ('CMU103', 19, 1, 'occupied'), ('CMU104', 19, 0, 'available'), ('CMU105', 19, 0, 'available'),
('CMU201', 20, 1, 'occupied'), ('CMU202', 20, 0, 'available'), ('CMU203', 20, 1, 'occupied'), ('CMU204', 20, 0, 'available'), ('CMU205', 20, 0, 'available'),

-- Phuket Beach Dormitory (Rooms 101-110)
('PBD101', 21, 1, 'occupied'), ('PBD102', 21, 0, 'available'), ('PBD103', 21, 1, 'occupied'), ('PBD104', 21, 0, 'available'), ('PBD105', 21, 0, 'available'),
('PBD201', 22, 1, 'occupied'), ('PBD202', 22, 0, 'available'), ('PBD203', 22, 1, 'occupied'), ('PBD204', 22, 0, 'available'), ('PBD205', 22, 0, 'available');
